...
#pragma omp parallel for
		...
		std::transform(y.cbegin(), y.cend(), ydot.cbegin(), y1.begin(), ([&deltaT](const FLOAT_TYPE &y_i, const FLOAT_TYPE &ydot_i) {
...
#pragma omp parallel for
		...
		if (deltaT > std::min<FLOAT_TYPE>(step_bound, (FLOAT_TYPE)(1.2 * factor_cfl * step_bound))) {
